    ...
    <body>
        <div class="mail-body">
            <div class="content" style="margin: 0px 15%;border: 1px solid #d4d1d1;">
                <?= Html::img('http://'.Yii::$app->getRequest()->serverName . '/avensiauae/admin/images/logo.png', $options = ['style' => 'width:200px;margin:0 auto;display: inherit;padding-top: 25px;']) ?>
                <div class="content-detail" style="padding: 0px 10%;">
                    <h2>Reset Your Password</h2>
                    <p>Hi <?= $model->name ?>,</p>
                    <p>You are requested to reset your password for your Avensia  Admin Panel Login. Click the below button to reset it</p>
