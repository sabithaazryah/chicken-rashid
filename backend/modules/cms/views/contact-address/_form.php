...
<div class="contact-address-form form-inline">
    ...
    <div class="row">
        <div class='col-md-4 col-sm-6 col-xs-12 left_padd'>
            <?= $form->field($model, 'address_title')->textInput(['maxlength' => true]) ?>
        </div>
        <div class='col-md-4 col-sm-6 col-xs-12 left_padd'>
    ...
    <div class="row">
        ...
        <div class='col-md-4 col-sm-6 col-xs-12 left_padd'>
            <?= $form->field($model, 'tech_solution_phone')->textInput(['maxlength' => true]) ?>
        </div>
        <div class='col-md-4 col-sm-6 col-xs-12 left_padd'>
        ...
        <!--        <div class='col-md-4 col-sm-6 col-xs-12 left_padd'>
        <?php // $form->field($model, 'default_address')->checkbox(); ?>
                </div>-->
    </div>
    <div class="row">
