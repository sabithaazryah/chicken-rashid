...
use common\models\TechnicalServicesSearch;
...
class TechnicalServicesController extends Controller {
    ...
    /**
     * Lists all TechnicalServices models.
     * @return mixed
     */
    public function actionIndex() {
        $searchModel = new TechnicalServicesSearch();
    ...
    /**
     * Displays a single TechnicalServices model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new TechnicalServices model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate() {
        $model = new TechnicalServices();
        ...
        if ($model->load(Yii::$app->request->post()) && Yii::$app->SetValues->Attributes($model)) {
            ...
            if ($model->validate() && $model->save()) {
                ...
                Yii::$app->session->setFlash('success', "Technical Services added Successfully");
                $model = new TechnicalServices();
            }
    ...
    public function Upload($files, $model, $type) {
        if ($files != '' && $model != '') {
            ...
            $paths = Yii::$app->basePath . '/../uploads/technical_services/' . $folder . '/' . $model->id;
    ...
    /**
     * Updates an existing TechnicalServices model.
    ...
    public function actionUpdate($id) {
        ...
        if ($model->load(Yii::$app->request->post()) && Yii::$app->SetValues->Attributes($model)) {
            ...
            Yii::$app->session->setFlash('success', "Technical Services updated Successfully");
    ...
    /**
     * Deletes an existing TechnicalServices model.
    ...
    /**
     * Finds the TechnicalServices model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return TechnicalServices the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id) {
        if (($model = TechnicalServices::findOne($id)) !== null) {
            return $model;
        } else {
